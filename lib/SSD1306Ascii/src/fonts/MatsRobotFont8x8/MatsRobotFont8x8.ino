...
#ifndef MatsRobotFont8x8_H
#define MatsRobotFont8x8_H

GLCDFONTDECL(MatsRobotFont8x8) = {
...
179, 255, 255, 255, 255, 255, 255, 255, //'F'
255, 255, 255, 255, 255, 255, 255, 159, //'G'
207, 103,  35,   0,   0,   3, 252,   0, //'H'
  0, 128, 192,  31, 224,   0,   0, 128, //'I'
192,  64,  96,  32,  32,  16,  16,   8, //'J'
  8,   4,   2,   1,   3, 119, 127, 127, //'K'
 63, 191, 255, 255, 255,  39,  55,  27, //'L'
 11,  15,   7,  31, 127, 255, 255, 255, //'M'
252,   0,   0,   0,   0, 224,  31,   0, //'N'
  0,   7,   9,  17,  17,  33,  33,  32, //'O'
 32,  96, 160,  16,  16,  16,  16,  16, //'P'
  8,   8,   4,   4,   4,   2,   3,   1, //'Q'
  1,   0,   0,   0,   0,   0,   0,   0, //'R'
  0,   0,   0,   0,   0,   1,   3, 131, //'S'
 65,  32,  16,  12,   3,   0,   0,   0, //'T'
  0,   0,   0,   0,   0,   0,   0,   0, //'U'
  0,   0,   0,   1,   2,   2,   4,   4, //'V'
  8,   8,   8,  16,  16,  16,  32,  32, //'W'
 32,  32,  32,  32,  32,  16,  16,  16, //'X'
  8,   8,   4,   4,   2,   2,   1,   0, //'Y'
  0,   0,   0,   0,   0,   0,   0,   0, //'Z'
